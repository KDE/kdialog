...
int main(int argc, char *argv[])
{
    ...
    parser.addOption(QCommandLineOption(QStringList() << QStringLiteral("dontagain"), i18n("Config file and option name for saving the \"do-not-show/ask-again\" state"), QStringLiteral("file:entry")));
